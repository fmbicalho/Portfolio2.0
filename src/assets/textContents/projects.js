...
import carBuddyImage from "/images/carbuddy-app.png";
...
export const projectData = [
  {
    ...
    languages: ["Java", "SpringBoot", "JavaScript", "MySQL", "HTML", "CSS"],
    image: libraryImage,
    onlineLink: "",
  ...
  },
  {
    ...
    title: "Fighting Game",
    description:
      "Single-Player Fighting game based on the Code for all_ Bootcamp professors.",
    languages: ["Java", "Simple Graphics"],
    image:
      "https://github.com/user-attachments/assets/2f9a34d4-b16b-4f74-bbe1-487094810cf1",
    onlineLink: "",
  ...
  },
  {
    ...
    description:
      "A game based on the original Slimetrail, created during Algorithm Laboratory I Course at University of Minho.",
    languages: ["C"],
    image:
      "https://cf.geekdo-images.com/tYxS-l2Z8FkehH7eIQFY9A__opengraph/img/jA27SaLhCBZqH0zmZq-fhh-9nBY=/fit-in/1200x630/filters:strip_icc()/pic332409.jpg",
    onlineLink: "",
  ...
  },
  {
    ...
    description:
      "It's a server-based Java program using IO Network, developed during the CodeforAll_ Bootcamp.",
  ...
  },
  {
    ...
    languages: ["Node.js", "Express.js", "Objection", "MySQL", "HTML", "CSS"],
    image: weddingImage,
    onlineLink: "",
  ...
  },
  {
    ...
    description:
      "This Python program synchronizes files between a source folder and a replica folder. Created with Python.",
    languages: ["Python"],
    image: pythonImage,
    onlineLink: "",
  ...
  },
  {
    ...
    description:
      "This React Web Application was created to help everybody going to grocery. Created with React and Javascript.",
  ...
  },
  {
    ...
    description:
      "A Single Page Application created with JS, HTML and CSS. A cinema management app, to be used by a cinema company.",
    languages: ["JavaScript", "HTML", "CSS"],
    image: cinemaImage,
  ...
  },
  {
    ...
    onlineLink: "",
    repoLink:
      "https://github.com/fmbicalho/miniBingo/tree/main/anotherBingoGame",
  },
  {
    id: 12,
    title: "E-Commerce",
